...
class SelectDialog(pyxbmct.AddonDialogWindow):
    def __init__(self, title="", stype=None, sort=None, status=None, genre=None, callback=None):
        ...
        self.set_column(0, 0, "Type:", self.type or [])
        self.set_column(0, 6, "Sort:", self.sort or [])
        ...
        self.column_items.append([])
        self.set_column(2, 0, "", self.genre[0:(len(self.genre) / 3) - 1] or [])
        ...
        self.check_uncheck(self.column_items[0][6])  # Score -
