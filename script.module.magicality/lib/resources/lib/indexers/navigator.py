...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32005, 'movieWidget', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('IMDB Top 100', 'movies&url=top3', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('IMDB Top 250', 'movies&url=top2', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('IMDB Top 1000', 'movies&url=top4', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('IMDB Best Director Winning', 'movies&url=bestd', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('National Film Board Preserved ', 'movies&url=nfb', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('Fox', 'movies&url=fox', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Paramount', 'movies&url=para', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('MGM', 'movies&url=pmgm', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Disney', 'movies&url=disney1', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Universal', 'movies&url=uni', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Sony', 'movies&url=sony', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Warner Bros', 'movies&url=warb', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('IMDB Prime Video', 'movies&url=primev', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Classic', 'movies&url=classmov', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Classic Western', 'movies&url=classwest', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Classic Animation', 'movies&url=classani', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Classic War', 'movies&url=classwar', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Classic Sci-fi', 'movies&url=classsci', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Eighties', 'movies&url=eighties', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Nineties', 'movies&url=nineties', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Noughties', 'movies&url=noughties', 'movies.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Twenty Tens', 'movies&url=twentyten', 'movies.png', 'DefaultTVShows.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem('IMDB Prime Video', 'tvshows&url=usprime', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Documentaries', 'tvshows&url=docsa', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Mystery', 'tvshows&url=myst', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Sci-Fi', 'tvshows&url=scifi1', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('User Rating 7 to 10', 'tvshows&url=userr', 'highly-rated.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Mini-Series', 'tvshows&url=mini', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Classic', 'tvshows&url=classtv', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Paranormal', 'paranormalNavigator', 'genres.png', 'DefaultTVShows.png')
        self.addDirectoryItem('PG-PG13', 'tvshows&url=pg', 'genres.png', 'DefaultTVShows.png')
    ...
    def paranormal(self, lite=False):
        self.addDirectoryItem('Ghost Adventures', 'tvshows&url=ghostadv', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Deadly Possessions', 'tvshows&url=deadp', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Most Haunted', 'tvshows&url=mosth', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Ghost Hunters', 'tvshows&url=ghosth', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('paranormal Witness', 'tvshows&url=paraw', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('paranormal Lockdown', 'tvshows&url=paral', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('A Haunting', 'tvshows&url=haunt', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Haunted Collector', 'tvshows&url=hauntc', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Ghost Asylum', 'tvshows&url=ghosta', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Ghost Inside My Child', 'tvshows&url=ghosti', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('My Ghost Story', 'tvshows&url=paran', 'tvshows.png', 'DefaultTVShows.png')
