...
class flixanity:
    ...
    name = 'Flixanity.is'
    menu = [('Filme Recent Adăugate', '%s/new-movies' % base_url, 'recente', thumb),
            ('Episoade Noi', '%s/new-episodes' % base_url, 'recente', thumb),
            ('Genuri Filme', '%s/movies' % base_url, 'genuri', thumb),
            ('Filme după data apariției', '%s/movies/release-date' % base_url, 'recente', thumb),
            ('Filme după popularitate', '%s/movies/popular' % base_url, 'recente', thumb),
            ('Filme cele mai vizionate', '%s/movies/most-watched' % base_url, 'recente', thumb),
            ('Seriale după popularitate', '%s/tv-shows/popular' % base_url, 'recente', thumb),
            ('Seriale cele mai vizionate', '%s/tv-shows/most-watched' % base_url, 'recente', thumb),
            ('Seriale după nota IMDb', '%s/tv-shows/imdb-rating' % base_url, 'recente', thumb),
            ('Genuri Seriale', '%s/tv-shows' % base_url, 'genuri_seriale', thumb),
    ...
    def cauta(self, keyword, result):
        result.append((self.__class__.__name__, self.name, self.parse_menu(keyword, 'cautare')))
    ...
    def parse_menu(self, url, meniu, info={}):
        ...
        if meniu == 'recente' or meniu == 'cauta':
            ...
            s.headers.update({'User-Agent': randomagent(),
                            'Cookie': cooked,
            ...
            s.headers.update = ({'Host': 'api.flixanity.io',
