        ...
        if meniu == 'recente' or meniu == 'cauta':
            ...
            for numerotare, linknumerotare, linknumerotareunu in match_lnk:
                ...
                if 'goo.gl' in linknumerotare:
                    ...
                    try:
                        host = linknumerotare.split('/')[2].replace('www.', '').capitalize()
                        if not numerotare: host = episod + ': ' + host
                        lists.append((host,linknumerotare,'','play', str(infos), url))
                    except:
                        host = linknumerotareunu.split('/')[2].replace('www.', '').capitalize()
                        lists.append((host,linknumerotareunu,'','play', str(infos), url))
